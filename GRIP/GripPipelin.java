...
public class GripPipelin implements VisionPipeline {
	...
	public void process(Mat source0) {
		...
		//put
		processContours(filterContoursContours, possibleRect, possibleGoal);
		 ...
		 * 			compare distance and width to desired ratio
		 * 			if there is a match, calculate score (how good a fit)
		 * 				set gearTargetFound = true
		 * 				if its a better score than previous match, record its data
		 * 					centerX, centerY, score
		 */
		...
		try{
			vision.putBoolean("gearTargetFound", true);
