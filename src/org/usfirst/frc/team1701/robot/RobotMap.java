...
public class RobotMap {
    ...
    public static Encoder driveTrainLeftQuadEncoder;
    public static Encoder driveTrainRightQuadEncoder;
    ...
    public static void init() {
        ...
        driveTrainLeftQuadEncoder = new Encoder(2, 3, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveTrain", "LeftQuadEncoder", driveTrainLeftQuadEncoder);
        driveTrainLeftQuadEncoder.setDistancePerPulse(1.0);
        driveTrainLeftQuadEncoder.setPIDSourceType(PIDSourceType.kRate);
        driveTrainRightQuadEncoder = new Encoder(4, 5, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveTrain", "RightQuadEncoder", driveTrainRightQuadEncoder);
        driveTrainRightQuadEncoder.setDistancePerPulse(1.0);
        driveTrainRightQuadEncoder.setPIDSourceType(PIDSourceType.kRate);
        shooterSystemShootingEncoder = new Encoder(6, 7, false, EncodingType.k4X);
        ...
        gearArmGearDistanceSensor = new AnalogInput(1);
...
//        driveTrainRobotDrive41 = new RobotDrive(driveTrainLeft_1, driveTrainLeft_2,
...
//        driveTrainRobotDrive41.setMaxOutput(1.0);
        ...
        climberMotor = new CANTalon(15);
        pickupBottomMotor = new CANTalon(14);
        hopperMotor = new CANTalon(8);
