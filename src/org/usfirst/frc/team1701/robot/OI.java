...
public class OI {
	...
	public OI() {
        ...
        forwardHopper = new JoystickButton(operation, 8);
        forwardHopper.whileHeld(new HopperForward());
        idleHopper = new JoystickButton(operation, 15);
        idleHopper.whileHeld(new HopperIdle());
        revHopper = new JoystickButton(operation, 15);
        ...
        climbOff = new JoystickButton(operation, 15);
        ...
        turboMode = new JoystickButton(drive_FB, 6);
        turboMode.whenPressed(new Turboify());
        preciseMode = new JoystickButton(drive_FB, 5);
        preciseMode.whenPressed(new Preciseify());
