...
public class DriveTrain extends Subsystem {
    ...
    private final Encoder leftQuadEncoder = RobotMap.driveTrainLeftQuadEncoder;
    private final Encoder rightQuadEncoder = RobotMap.driveTrainRightQuadEncoder;
	...
	public void setup() {
		leftQuadEncoder.setDistancePerPulse(WHEEL_CIRCUMFERENCE / PULSES_PER_ROTATION);
		rightQuadEncoder.setDistancePerPulse(WHEEL_CIRCUMFERENCE / PULSES_PER_ROTATION);
	}

	public Encoder getLeftEncoder() {
		return leftQuadEncoder;
	}

	public Encoder getRightEncoder() {
		return rightQuadEncoder;
	}
	/*
